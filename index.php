...
$pengeluaran_hari_ini = isset($pengeluaran_hari_ini['jumlah']) ? $pengeluaran_hari_ini['jumlah'] : 0;
...
$pemasukan_hari_ini = isset($pemasukan_hari_ini['jumlah']) ? $pemasukan_hari_ini['jumlah'] : 0;
...
$sekarang = isset($sekarang['jumlah']) ? $sekarang['jumlah'] : 0;
...
$satuhari = isset($satuhari['jumlah']) ? $satuhari['jumlah'] : 0;
...
$duahari = isset($duahari['jumlah']) ? $duahari['jumlah'] : 0;
...
$tigahari = isset($tigahari['jumlah']) ? $tigahari['jumlah'] : 0;
...
$empathari = isset($empathari['jumlah']) ? $empathari['jumlah'] : 0;
...
$limahari = isset($limahari['jumlah']) ? $limahari['jumlah'] : 0;
...
$enamhari = isset($enamhari['jumlah']) ? $enamhari['jumlah'] : 0;
...
$tujuhhari = isset($tujuhhari['jumlah']) ? $tujuhhari['jumlah'] : 0;
?>
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-success shadow h-100 py-2">
            ...
            <?php echo number_format($jumlahmasuk,2,',','.'); ?>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-danger shadow h-100 py-2">
            ...
            <?php echo number_format($jumlahkeluar,2,',','.'); ?>
          </div>
        </div>
